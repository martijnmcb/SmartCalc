...
# Functie om postcodes te geocoderen
...
# Functie om kortste route te bepalen via permutatie
...
if st.button("🚗 Bereken route"):
    ...
    if route_orig and route_orig.get("code") == "Ok":
        ...
        st_folium(m1, height=400, key="map_orig")
    else:
    ...
    if optimize:
        ...
        st_folium(m2, height=400, key="map_opt")
